print("*** LOADING mfd.nas ... ***");
#######################################################################
#                                                                     #
#                 MULTI FUNCTION DISPLAY SETTINGS                     #
#                                                                     #
#######################################################################
...
var update_rmi1 = func {
  ...
  if (rmi1_src == "") {
    ...
    if ((getprop("/instrumentation/gps/mode") == "dto") and (getprop("instrumentation/nav/slaved-to-gps") == 1)) {
...
var update_rmi2 = func {
  ...
  if (rmi2_src == "") {
    ...
    setprop(RMI2ident, getprop("/instrumentation/adf[0]/ident"));
    setprop(RMI2dist, 0);
  }
}
...
var frequ_swapR = func() {
  ...
  if (rmu_R == 1) {
    stb = "/instrumentation/adf[0]/frequencies/standby-khz";
    sel = "instrumentation/adf[0]/frequencies/selected-khz";
    swp();
  } elsif (rmu_R == 2) {
...
var frequ_adjustR = func(dir) {
  ...
  if (rmuR == 1) {
    frequ = "/instrumentation/adf[0]/frequencies/standby-khz";
    adj_adf();
  } elsif (rmuR == 2) {
